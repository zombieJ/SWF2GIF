...
package org.gif.encoder
{
	...
	public class GIFEncoder
	{
		...
		protected var width:int // image size
  		protected var height:int;
	    protected var transparent:* = null; // transparent color if given
	    protected var transIndex:int; // transparent index in color table
	    ...
	    protected var image:Bitmap; // current frame
	    protected var pixels:ByteArray; // BGR byte array from frame
	    protected var indexedPixels:ByteArray // converted frame indexed to palette
	    protected var colorDepth:int; // number of bit planes
	    protected var colorTab:ByteArray; // RGB palette
	    protected var usedEntry:Array = new Array; // active palette entries
		...
		*/
		...
		protected function findClosest(c:Number):int
		{
		...
		*/
		...
		protected function getImagePixels():void
		{
		...
		*/
		...
		protected function writeGraphicCtrlExt():void
		{
		...
		*/
		...
		protected function writeImageDesc():void
		{
		...
		*/
		...
		protected function writeLSD():void
		{
		...
		*/
		...
		protected function writeNetscapeExt():void
		{
		...
		*/
		...
		protected function writePalette():void
		{
		...
		protected function WriteShort (pValue:int):void
		{  	
		...
		*/
		...
		protected function writePixels():void
		{
